...
result = pyfiglet.figlet_format("jacksparrow6455")
...
time.sleep(1)
pyautogui.typewrite("https://hack.chat/?jacksparrow6455")
pyautogui.press("enter")
time.sleep(3)
pyautogui.typewrite("jacksparrow6455",interval=0.1)
pyautogui.press("enter")
...
pyautogui.press("enter")
pyautogui.typewrite("P.S. Hacked By JackSparrow6455!",interval=0.1)
pyautogui.press("enter")
